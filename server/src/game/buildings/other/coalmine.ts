...
export class CoalMine extends Building {
  public constructor(building: EntityType) {
    super(building);

    this.production = new Production(10000, 7000, "ores", "coal");
    this.range = 2;
  }
  ...
  public produce(
    ...
    if (!cellInstance || (cellInstance && !(cellInstance instanceof Coal))) {
      return null;
    }
    ...
    if (closestCell && cellInstance.getAmount() <= 1) {
      closestCell.removeObstacle(ObstacleEnum.Coal);
